...
public class PathFormat {
	...
	public static final String PATH_FORMAT_DEFAULT = "/{yyyy}/{mm}/{dd}/{hh}{ii}{ss}_{rand:6}";
	...
	private static final Pattern parsepattern = Pattern.compile( "\\{([^\\}]+)\\}", Pattern.CASE_INSENSITIVE  );
